...
public class Extenso {
  ...
  private String[][] Qualificadores = new String[][] { { "centavo", "centavos" }, { "", "" }, { "mil", "mil" }, { "milhao", "milhaes" }, { "bilhao", "bilhaes" }, { "trilhao", "trilhaes" }, { "quatrilhao", "quatrilhaes" }, { "quintilhao", "quintilhaes" }, { "sextilhao", "sextilhaes" }, { "septilhao", "septilhaes" } };
  
  private String[][] Numeros = new String[][] { { 
        "zero", "um", "dois", "tres", "quatro", "cinco", "seis", "sete", "oito", "nove", 
        "dez", "onze", "doze", "treze", "quatorze", "quinze", "desesseis", "desessete", "dezoito", "desenove" }, { "vinte", "trinta", "quarenta", "cinquenta", "sessenta", "setenta", "oitenta", "noventa" }, { "cem", "cento", "duzentos", "trezentos", "quatrocentos", "quinhentos", "seiscentos", "setecentos", "oitocentos", "novecentos" } };
  ...
  private boolean ehPrimeiroGrupoUm() {
    if (((Integer)this.nro.get(this.nro.size() - 1)).intValue() == 1)
      return true; 
    return false;
  }
