 ...
 * ModificacionClienteBean.java
 * Control de versiones:
 * Version  Date/Hour               By                  				Company     Description
 * -------  -------------------     --------------------------------    --------    -----------------------------------------------------------------
 * 1.0      10 nov. 2020 14:05:30	    [Sergio Jair Flores Luna]     			  SYM		    Creacion de ModificacionClienteBean.java
 */
 ...
 *
 */
public class ModificacionClienteBean implements Serializable {
	 ...
	 */
	private static final long serialVersionUID = -2315972877910147227L;
