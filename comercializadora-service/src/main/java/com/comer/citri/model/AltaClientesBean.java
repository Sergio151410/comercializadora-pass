 ...
 * AltaClientesBean.java
 * Control de versiones:
 * Version  Date/Hour               By                  				Company     Description
 * -------  -------------------     --------------------------------    --------    -----------------------------------------------------------------
 * 1.0      10 nov. 2020 14:05:03	    [Sergio Jair Flores Luna]     			  SYM		    Creacion de AltaClientesBean.java
 */
 ...
 *
 */
public class AltaClientesBean implements Serializable{
	 ...
	 */
	private static final long serialVersionUID = 7586051945315616454L;
