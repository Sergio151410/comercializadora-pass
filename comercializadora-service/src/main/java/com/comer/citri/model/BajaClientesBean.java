 ...
 * BajaClientesBean.java
 * Control de versiones:
 * Version  Date/Hour               By                  				Company     Description
 * -------  -------------------     --------------------------------    --------    -----------------------------------------------------------------
 * 1.0      10 nov. 2020 14:05:16	    [Sergio Jair Flores Luna]     			  SYM		    Creacion de BajaClientesBean.java
 */
 ...
 *
 */
public class BajaClientesBean implements Serializable {
	 ...
	 */
	private static final long serialVersionUID = -4387465217543905921L;
