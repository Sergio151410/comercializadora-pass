 ...
 * ModificacionProductosBean.java
 * Control de versiones:
 * Version  Date/Hour               By                  				Company     Description
 * -------  -------------------     --------------------------------    --------    -----------------------------------------------------------------
 * 1.0      21 sep. 2020 18:55:43	    [Sergio Jair Flores Luna]     			  SYM		    Creacion de ModificacionProductosBean.java
 */
 ...
 *
 */
public class ModificacionProductosBean implements Serializable{
	 ...
	 */
	private static final long serialVersionUID = -7531174391851630823L;
